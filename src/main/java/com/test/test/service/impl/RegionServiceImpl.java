...
public class RegionServiceImpl implements IRegionService {
	...
	RegionServiceImpl(ApiRegionDao ApiRegionDaoImpl){
		this.ApiRegionDaoImpl = ApiRegionDaoImpl;
	}

	@Override
	public List<Region> getRegionByRegion(Integer idRegion, String nameComuna) {
		log.debug("Init Serach Region by idRegion: %d or nameComune: %s", idRegion, nameComuna);
		...
		log.debug("Result search: %d",lstRegion.size());
